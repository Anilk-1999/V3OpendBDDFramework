...
public class CampaignsTest extends BaseClass
{
	...
	{
		campaignsPage.selectOptionInDropdown("Select Audience Type","UK Consumer Data");
	}
	...
	public void select_a_publishers_from_publisher_popup_dropdown()
	{
	   ...
	   campaignsPage.SelectOptionInPopupDropdown("Select Publisher", options, "Select Publisher");
	}
	...
	public void Clicks_on_proceed_button_in_second_step() throws InterruptedException
	{
