...
public class SuppressionTest extends BaseClass
{
	...
	public void make_sure_that_the_suppression_type_popup_is_displayed() throws InterruptedException 
	{
	    ...
	    Assert.assertEquals(suppressionPage.getPopupHeading(), "Suppression Type");
	}
	...
	{
	   suppressionPage.setSuppressionlistName(setRandomBusinessName());
	}
	...
	public void upload_a_suppression_file() throws AWTException 
	{
	   ...
	   contactPage.setFileUpload("/home/active30/Documents/csvFiles/100contactsnew.csv");
	}
	...
	{
	    contactPage.setMappingDropdowns();
	}
